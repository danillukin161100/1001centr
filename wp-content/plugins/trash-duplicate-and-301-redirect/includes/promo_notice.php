            ...
            <style>/* Promotional notice css*/
                ...
                <div class="notice notice-success" id="tdrd_promo" style="min-height:120px">
                        ...
                        <p>
                            ...
                            <a class="tdrd_button tdrd_button2" target="_blank" href="https://wordpress.org/support/plugin/trash-duplicate-and-301-redirect/reviews/?filter=5">' . esc_html__( 'Rate it', 'trash-duplicate-and-301-redirect' ) . " 5★'s" . '</a>
